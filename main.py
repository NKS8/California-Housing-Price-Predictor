...
def generate_prediction():
    ...
    'MasVnrType':[float(user_inputs['MasVnrType'])],
    ...
    'BsmtQual':[float(user_inputs['BsmtQual'])],
    'BsmtCond':[float(user_inputs['BsmtCond'])],
    'BsmtExposure':[float(user_inputs['BsmtExposure'])],
    'BsmtFinType1':[float(user_inputs['BsmtFinType1'])],
    ...
    'Electrical':[float(user_inputs['Electrical'])],
    ...
    'GarageType':[float(user_inputs['GarageType'])],
    'GarageYrBlt':[float(user_inputs['GarageYrBlt'])],
    'GarageFinish':[float(user_inputs['GarageFinish'])],
    'GarageCars':[float(user_inputs['GarageCars'])],
    'GarageArea':[float(user_inputs['GarageArea'])],
    'GarageQual':[float(user_inputs['GarageQual'])],
    'GarageCond':[float(user_inputs['GarageCond'])],
    ...
    'PoolQC':[float(user_inputs['PoolQC'])],
    'Fence':[float(user_inputs['Fence'])],
    'MiscFeature':[float(user_inputs['MiscFeature'])],
